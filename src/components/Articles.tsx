        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 relative">
          ...
          {articles.slice(1).map((article) => (
            <div
              ...
              className="rounded overflow-hidden col-span-3 lg:col-span-2 shadow md:shadow-none hover:shadow-md md:hover:shadow p-2 cursor-pointer h-fit relative transition-all duration-200 hover:bg-white flex flex-col lg:flex-row w-full"
            >
              {/* Bagian Gambar */}
              <div className="w-full lg:w-[220px] h-[200px] lg:h-[150px] shrink-0 overflow-hidden rounded">
                <img
                  src={article.image}
                  alt={article.title}
