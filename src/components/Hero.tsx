      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        >
          ...
          >
            ...
            >
              <motion.button
                className="bg-[#61876b] hover:bg-[#0c442c] text-white flex space-x-3 px-6 py-2 items-center justify-center rounded-xl"
              ...
              <motion.button
                className="border-[#61876b] text-[#61876b] hover:bg-pesantren-50 border px-6 py-2 rounded-xl"
                variants={buttonHover}
                whileHover="hover"
                whileTap="tap"
              >
